    ...
    useEffect(() => {
        if (typeof window !== "undefined") {
            window.addEventListener("scroll", () =>
                setHeaderChangeColor(window.pageYOffset > 600)
            );
        }
    }, []);

    return (
        <div className={`${styles.headerContainer} fixed-top`} style={{ height: "80px", backgroundColor: `${headerChangeColor ? "white" : "#FDF8EE"}` }}>
            <Navbar expand="lg" className='pt-3'>
                ...
                <Navbar.Collapse id="navbarScroll" className='pt-1'>
                    ...
                    <Form className="d-flex">
                        ...
                        <Link href="/Login" className={`${styles.navbarLink} pt-1 px-lg-3`} style={{ color: "#6E6E6D", textDecoration: 'none' }}>Log in</Link>
